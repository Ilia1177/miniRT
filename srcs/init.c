...
int	scene_init(t_data *scene)
{
	...
	scene->objects->reflective = (t_argb) {0, 0, 0, 0};
...
//	scene->objects->next->next->next->reflective = (t_argb) {0, 0, 0, 0};
...
//	scene->objects->next->next->next->next->reflective = (t_argb) {0, 0, 0, 0};
...
//	scene->objects->next->next->next->next->next->specular = -1;
//	scene->objects->next->next->next->next->next->reflective = (t_argb) {0, 85, 13, 5};
...
//	scene->objects->next->next->next->next->next->next->specular = 5000;
//	scene->objects->next->next->next->next->next->next->reflective = (t_argb) {0, 8, 10, 10};
...
//	scene->objects->next->next->next->next->next->next->next->specular = 5000;
//	scene->objects->next->next->next->next->next->next->next->reflective = (t_argb) {0, 8, 10, 10};
...
//	scene->lights->next->intensity = (t_argb) {255, 250, 250, 250};
